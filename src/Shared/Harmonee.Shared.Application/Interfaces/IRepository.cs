...
public interface IRepository<T> where T : class, IEntity
{
    ...
    public Task<IEnumerable<T>> Search(IEntityFilter<T> filter, CancellationToken cancellationToken);
    public Task<T?> FirstOrDefault(IEntityFilter<T> filter, CancellationToken cancellationToken, T? defaultValue = default(T));
